...
class ArticleServiceTest {
    ...
    @Test
    @Transactional
    void create_실패() {//title과 content만 있는 dto 입력
        //예상
        String title = "라라라라";
        String content = "4444";
        ArticleForm dto = new ArticleForm(4L,title,content);
        Article expected = null;
//        Article expected = new Article(4L,title,content); //맞지 않는 값이라
//        실행 오류가 난다.
        ...
        System.out.println("실제 결과: " + article);
//        System.out.println("실제 결과: " + article.toString());
    }
    ...
    void update_성공() {
        ...
        Article expeced = new Article(id,"가나가나가나", "121212");
